...
//  }
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Okapi BM25 Peformance:");
        evaluator.evaluate("--ok", _prefix + _indexPath, _prefix + _judgment);

        System.out.println("tfidf Peformance:");
        evaluator.evaluate("--tfidf", _prefix + _indexPath, _prefix + _judgment);
